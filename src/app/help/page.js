...
const faqs = [
  ...
  },
  {
    ...
    a: "Хүсэлтийг администратор гараар шалгадаг. Ихэвчлэн хэдэн минутад баталгаажуулдаг — хэрэв илүү хугацаа бол hello@vxnta.app хаягаар холбогдоно уу.",
  },
  {
    q: "Монгол төлөвлөгөө идийм бол админ дарж approve хийх юу?",
    a: "Тийм ээ. Та Khan Bank дээр шилжүүлсний дараа «Submit receipt» дарсан бөгөөд төлбөр PENDING заасан ч үзэх боломжгүй. Систем үзүүлсэн бүх төлбөрийг admin@vxnta.mn хаягт логин хийсний дараа /admin/payments хуудас руу ороод «Approve» товч дарж баталгаажуулна. Баталгаажих нь VIP-ийг автоматаар сунгах бөгөөд хувилбарыг мөн өргөдлийг илгүүлнэ.",
  },
  {
    q: "Хэрхэн админ болон мэнєтлєгchur?",
    a: "Админ нь admin@vxnta.mn хаягаар нэвтрэнэ. Энэ хэрэглэгчдэд SUPER_ADMIN эрхтэй бөгөөд /admin хуудас руу ороход бүрийн тохьдолд түгэйтэл юм. Бусад хэрэглэгчид USER эрхтэй.",
  },
  {
